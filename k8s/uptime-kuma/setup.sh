...
show_access_info() {
    ...
    print_info "========================================="
    echo ""
    print_info "URL: https://monitoring.hbg.local"
    echo ""
    print_warning "Make sure to add 'monitoring.hbg.local' to your /etc/hosts file:"
    print_info "  sudo sh -c 'echo \"<YOUR_CLUSTER_IP> monitoring.hbg.local\" >> /etc/hosts'"
    echo ""
